...
class Calculator1():
    ...
    def calculate(self, request : FlaskRequest) -> Dict:
        ...
        splited_data = input_data / 3 
        first_process_result = self.__first_process(splited_data)
        second_process_result = self.__second_process(splited_data)
        calc_result = first_process_result + second_process_result + splited_data
